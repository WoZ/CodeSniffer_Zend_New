<?php
/**
 * ZendNew_Sniffs_NamingConventions_ValidVariableNameSniff.
 *
 * PHP version 5
 *
 * @category  PHP
 ...
 * ZendNew_Sniffs_NamingConventions_ValidVariableNameSniff.
 *
 * Checks the naming of variables and member variables. Extended from Squiz' standard, because we
 * categorize protected variables not as public!
 *
 * @category  PHP
 * @package   PHP_CodeSniffer
 * @author    Greg Sherwood <gsherwood@squiz.net>
 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class ZendNew_Sniffs_NamingConventions_ValidVariableNameSniff extends Squiz_Sniffs_NamingConventions_ValidVariableNameSniff
{
    ...
    protected function processMemberVar(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        $public    = (!(in_array($memberProps['scope'], array('private', 'protected'))));

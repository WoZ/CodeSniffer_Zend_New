 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class ZendNew_Sniffs_Commenting_FunctionCommentSniff implements PHP_CodeSniffer_Sniff
{
    ...
    protected function processParams($commentStart)
    {
        ...
        if (empty($params) === false) {
            ...
            foreach ($params as $param) {
                ...
                $isEmptyComment = mb_strlen($paramComment) === 0 ? true : false;
                ...
                if ($previousParam !== null) {
                    ...
                    // Don't try to align param with comment and empty one
                    if (! ($isEmptyComment || $previousIsEmptyComment)
                        && $param->alignsCommentWith($previousParam) === false
                    ) {
                ...
                $previousParam = $param;
                $previousIsEmptyComment = $isEmptyComment;
